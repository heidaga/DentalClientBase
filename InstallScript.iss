...
#define DATA_APP "res"
#define DATA_SAMPLES "samples"
#define DATA_INVOICE "invoice"
...
Source: "{#DISTRIB}\{#DATA_APP}\*"; DestDir: "{app}\{#DATA_APP}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#DISTRIB}\{#DATA_INVOICE}\*"; DestDir: "{app}\{#DATA_INVOICE}"; Flags: ignoreversion recursesubdirs createallsubdirs
